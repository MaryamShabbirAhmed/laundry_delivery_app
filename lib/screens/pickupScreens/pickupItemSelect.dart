  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar:  Row(children: [  Container(
            width: Get.width/1.2,
            child: CustomButton(label: 'Submit', onPressed: (){ _showBottomSheet(context);},)),
          Padding(
            padding:EdgeInsets.only(left:20.0),
            child: Icon(Icons.arrow_upward_outlined,color: Colors.blue, ),
          ),
                        ...
                        child: Stack(
                          children: [
                            InkWell(
                                ...
                                child: Center(
                                    child: Image.network(itemsimage[index]))),
                            Padding(
          ...
          Column(children: [
            Row(
              ...
              Padding(
                ...
                child: Text('Payement', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 20),),
              ),
              Padding(
            ...
            Padding(
              ...
              child: Row(
                ...
                Text('PKR 20.20', style: TextStyle(),),
            ...
            Container(height: 1,color: Colors.grey,width: Get.width,),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ...
                  Text('PKR 40.40', style: TextStyle(),),
